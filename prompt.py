...
4️⃣ importe: Extrae el monto total de la factura y conviértelo al formato español (el punto como separador decimal y elimina separadores de miles).
5️⃣ moneda: Determina la moneda de la factura:
   - Si contiene "ARS" o "$" o cualquier otro indicador de que la moneda son pesos argentinos, devuelve "Pesos Argentinos".
   - Si contiene "USD" o "U$" o cualquier otro indicador de que la moneda son dólares US, devuelve "dolares".
...
11/01/2024;amazon services europe sà r.l.;soporte de micrófono ajustable;19.99;Pesos Argentinos
12/01/2024;raiola networks sl;hosting base ssd 20;119.91;Pesos Argentinos
